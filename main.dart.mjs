...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1440: () => new XMLHttpRequest(),
      _1441: (x0,x1,x2) => x0.open(x1,x2),
      _1442: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      _1443: x0 => x0.abort(),
      _1444: (x0,x1) => x0.send(x1),
      _1445: x0 => x0.send(),
      _1446: x0 => x0.getAllResponseHeaders(),
      ...
      _1534: Function.prototype.call.bind(Number.prototype.toString),
      _1535: Function.prototype.call.bind(BigInt.prototype.toString),
      _1536: Function.prototype.call.bind(Number.prototype.toString),
      _1537: (d, digits) => d.toFixed(digits),
      _1631: x0 => x0.readyState,
      _1633: (x0,x1) => { x0.timeout = x1 },
      _1635: (x0,x1) => { x0.withCredentials = x1 },
      _1636: x0 => x0.upload,
      _1637: x0 => x0.responseURL,
      _1638: x0 => x0.status,
      _1639: x0 => x0.statusText,
      _1641: (x0,x1) => { x0.responseType = x1 },
      _1642: x0 => x0.response,
      _1654: x0 => x0.loaded,
      _1655: x0 => x0.total,
      _1718: x0 => x0.style,
      _2077: (x0,x1) => { x0.download = x1 },
      _2102: (x0,x1) => { x0.href = x1 },
      _3424: () => globalThis.window,
      _3486: x0 => x0.navigator,
      _3875: x0 => x0.userAgent,
      _6105: () => globalThis.document,
      _6187: x0 => x0.body,
      _10983: (x0,x1) => { x0.display = x1 },
